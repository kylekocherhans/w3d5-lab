...
// CODE HERE
function changeHelloButtonDark() {
    sayHelloButton.classList.add("dark");
}

sayHelloButton.addEventListener("mouseover", changeHelloButtonDark);
...
// CODE HERE
function changeHelloButtonLight() {
    sayHelloButton.classList.remove("dark");
}

sayHelloButton.addEventListener("mouseout", changeHelloButtonLight);
...
const queryFunction = () => {
    ...
    axios.get("http://localhost:3000/query-test?name=kyle").then(res => {
        console.log(res.data);
    });

    axios.get("http://localhost:3000/query-test?name=kyle&age=34").then(res => {
        console.log(res.data);
    });
}
